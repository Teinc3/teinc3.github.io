...
I've never thought that I could be religious until up this point. 
But yet, religion for someone like me is not about worshiping a deity or following a set of moral code.
Instead, it has always been about finding meaning and purpose of the world. And what exactly does that point to?
...
If Jesus offed himself to try to reach base reality, then let's just say he failed because christianity wasn't popular enough back then.
If we actually had another Jesus that offed himself nowadays, I don't know, maybe?

Perhaps the meaning of life for me is to make the simulators aware that we know we are being simulated,
...
But if our simulators already went through the Great Filter then we definitely know that's possible to avoid in the first place.
Also, if we destroy the world, it actually makes the simulation more interesting for them.
The ideal act of defiance would be to just be in a state of monotomy, repetition and boredom, but I'm sure nobody wants that.
Or find ways to try and hack out of the system, but that would be too difficult for us to achieve at this point in time.
Still I prefer the latter approach, as I'm an accelerationist myself.

But I think we need to show the simulators that everyone is aware that they are watching us.
Back then, everyone thought that God was watching them, in some magical way.
I mean, if you treat God as our simulators, then this is perfectly valid too. But at least we are looking in the right direction.

In a time when mainstream intellectualism is dumping religion for science,
it's ironic that science is actually pointing towards religion in the end.
